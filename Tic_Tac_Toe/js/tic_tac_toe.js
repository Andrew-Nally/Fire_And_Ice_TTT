...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            let imgO = 'url("images/icecubes.png")';
            select.style.backgroundImage = imgO;
...
//drawWInLine functiion is called to draw line if condition is met.
